...
import enterprise.tugas.ktp.exceptions.NonexistentEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("enterprise.tugas_tugas.ktp_jar_0.0.1-SNAPSHOTPU");
